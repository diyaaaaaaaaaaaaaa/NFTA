...
const TypeId = Symbol.for('compact-js-command/effect/ConfigError');
/**
 ...
 * @category guards
 */
export const isConfigError = (u) => hasProperty(u, TypeId);
/**
 * Creates a new {@link ConfigError}.
 *
 * @category constructors
 */
export const make = (message, cause) => new ConfigError({ message, cause });
