...
/** @internal */
export const handler = ({ address, inputFilePath, newSigningKey, outputFilePath }, moduleSpec) => Effect.gen(function* () {
    ...
    const result = yield* contractModule.contractExecutable.replaceContractMaintenanceAuthority(Option.some(newSigningKey), {
        address,
...
//# sourceMappingURL=maintainContractCommand.js.map