...
import { ContractDeploy, Intent } from '@midnight-ntwrk/ledger-v7';
...
/** @internal */
export const handler = ({ outputFilePath, outputPrivateStateFilePath, outputZswapLocalStateFilePath, args }, moduleSpec) => Effect.gen(function* () {
    ...
    const result = yield* contractModule.contractExecutable.initialize(contractModule.createInitialPrivateState(), ...(yield* argsParser.parseInitializationArgs(args)));
