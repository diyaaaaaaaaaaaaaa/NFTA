...
import { ContractState as LedgerContractState } from '@midnight-ntwrk/ledger-v7';
import { Effect } from 'effect';
/** @internal */
export const asLedgerContractState = (state) => Effect.try({
...
/** @internal */
export const asLedgerContractStateFromBytes = (bytes) => Effect.try({
...
/** @internal */
export const asContractState = (state) => Effect.try({
