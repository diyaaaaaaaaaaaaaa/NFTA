 ...
 * @internal
 */
const makeFileSystemReader = (path, fs, baseAssetFolderPath) => (compiledContract) => 
...
Effect.gen(function* () {
    ...
    const getContractInfo = Effect.gen(function* () {
        ...
        cachedContractInfo = JSON.parse(contractInfoData);
        return cachedContractInfo;
    });
    const getVerifierKey = (impureCircuitId) => Effect.gen(function* () {
        ...
        return Option.none();
    }).pipe(Effect.mapError((err) => ZKConfigurationReadError.make(compiledContract.tag, impureCircuitId, 'verifier-key', err)));
    return {
        getVerifierKey,
 ...
 * @category layers
 */
export const layer = (baseAssetFolderPath = '.') => Layer.effect(ZKConfiguration.ZKConfiguration, Effect.gen(function* () {
...
//# sourceMappingURL=ZKFileConfiguration.js.map